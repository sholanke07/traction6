...
import kotlinx.android.synthetic.main.page_stock_counting.*
            ...
            if (!it.isFinishing) {
               ...
               /* appBarLayout.addOnOffsetChangedListener(AppBarLayout.OnOffsetChangedListener { appBarLayout, verticalOffset ->
                    if (abs(verticalOffset)  >= appBarLayout.totalScrollRange) { // collapse
                        ...
                        setCustomAnimations(R.anim.nav_default_enter_anim, R.anim.nav_default_pop_enter_anim,
                            R.anim.nav_default_exit_anim, R.anim.slide_out_to_right).
                        replace(R.id.frame_scanner, scanBarcodeFragment, ScanBarcodeFragment.SCANNER_TAG).commitNow()
                    }
                })*/
            }
        }
